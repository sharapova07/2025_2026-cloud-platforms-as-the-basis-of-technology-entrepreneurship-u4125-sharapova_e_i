...
```
mkdir ~/lab1-files (создание папки для файлов)
cd ~/lab1-files (переход в созданную папку)
gcloud storage cp gs://lab1-bucket-itmo/* (копирование всех файлов из бакета в текущую папку)
ls -lah (показ списка файлов)
```
